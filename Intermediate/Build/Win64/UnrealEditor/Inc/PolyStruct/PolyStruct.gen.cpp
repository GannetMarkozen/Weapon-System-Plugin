...
#include "PolyStruct/Public/Polymorphic/PolyStruct.h"
...
template<> POLYSTRUCT_API UScriptStruct* StaticStruct<FPolyStruct>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FPolyStruct_Statics::Struct_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/Polymorphic/PolyStruct.h" },
...
template<> POLYSTRUCT_API UScriptStruct* StaticStruct<FPolyStructHandle>()
{
	...
	struct Z_CompiledInDeferFile_FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_PolyStruct_Public_Polymorphic_PolyStruct_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_PolyStruct_Public_Polymorphic_PolyStruct_h_Statics::ScriptStructInfo[] = {
		{ FPolyStruct::StaticStruct, Z_Construct_UScriptStruct_FPolyStruct_Statics::NewStructOps, TEXT("PolyStruct"), &Z_Registration_Info_UScriptStruct_PolyStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPolyStruct), 458735111U) },
		{ FPolyStructHandle::StaticStruct, Z_Construct_UScriptStruct_FPolyStructHandle_Statics::NewStructOps, TEXT("PolyStructHandle"), &Z_Registration_Info_UScriptStruct_PolyStructHandle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPolyStructHandle), 255443861U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_PolyStruct_Public_Polymorphic_PolyStruct_h_1753750408(TEXT("/Script/PolyStruct"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_PolyStruct_Public_Polymorphic_PolyStruct_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_PolyStruct_Public_Polymorphic_PolyStruct_h_Statics::ScriptStructInfo),
		nullptr, 0);
