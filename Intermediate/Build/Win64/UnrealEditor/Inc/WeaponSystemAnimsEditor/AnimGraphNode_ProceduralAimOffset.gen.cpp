...
#include "WeaponSystemAnimsEditor/Public/AnimGraphNode_ProceduralAimOffset.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	WEAPONSYSTEMANIMSEDITOR_API UClass* Z_Construct_UClass_UAnimGraphNode_ProceduralAimOffset_NoRegister();
	WEAPONSYSTEMANIMSEDITOR_API UClass* Z_Construct_UClass_UAnimGraphNode_ProceduralAimOffset();
	ANIMGRAPH_API UClass* Z_Construct_UClass_UAnimGraphNode_Base();
	UPackage* Z_Construct_UPackage__Script_WeaponSystemAnimsEditor();
...
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_UAnimGraphNode_ProceduralAimOffset_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_WeaponSystemAnimsEditor,
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAnimGraphNode_ProceduralAimOffset, 2907451069);
	template<> WEAPONSYSTEMANIMSEDITOR_API UClass* StaticClass<UAnimGraphNode_ProceduralAimOffset>()
	{
		return UAnimGraphNode_ProceduralAimOffset::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAnimGraphNode_ProceduralAimOffset(Z_Construct_UClass_UAnimGraphNode_ProceduralAimOffset, &UAnimGraphNode_ProceduralAimOffset::StaticClass, TEXT("/Script/WeaponSystemAnimsEditor"), TEXT("UAnimGraphNode_ProceduralAimOffset"), false, nullptr, nullptr, nullptr);
