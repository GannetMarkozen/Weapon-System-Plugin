...
#include "WeaponSystemPlugin/Public/WeaponSystem/Character/WeaponSystemPlayerController.h"
...
template<> WEAPONSYSTEMPLUGIN_API UScriptStruct* StaticStruct<FNetParams>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNetParams_Statics::Struct_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/WeaponSystem/Character/WeaponSystemPlayerController.h" },
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AWeaponSystemPlayerController_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AWeaponSystemPlayerController_Client_Reliable_CallRemoteFunctionOnObject, "Client_Reliable_CallRemoteFunctionOnObject" }, // 4089633635
		{ &Z_Construct_UFunction_AWeaponSystemPlayerController_Client_Unreliable_CallRemoteFunctionOnObject, "Client_Unreliable_CallRemoteFunctionOnObject" }, // 933688918
		{ &Z_Construct_UFunction_AWeaponSystemPlayerController_Server_Reliable_CallRemoteFunctionOnObject, "Server_Reliable_CallRemoteFunctionOnObject" }, // 1346943246
		{ &Z_Construct_UFunction_AWeaponSystemPlayerController_Server_Unreliable_CallRemoteFunctionOnObject, "Server_Unreliable_CallRemoteFunctionOnObject" }, // 2143715806
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AWeaponSystemPlayerController_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "WeaponSystem/Character/WeaponSystemPlayerController.h" },
		{ "ModuleRelativePath", "Public/WeaponSystem/Character/WeaponSystemPlayerController.h" },
	};
#endif
	...
	struct Z_CompiledInDeferFile_FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_WeaponSystemPlugin_Public_WeaponSystem_Character_WeaponSystemPlayerController_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_WeaponSystemPlugin_Public_WeaponSystem_Character_WeaponSystemPlayerController_h_Statics::ScriptStructInfo[] = {
		{ FNetParams::StaticStruct, Z_Construct_UScriptStruct_FNetParams_Statics::NewStructOps, TEXT("NetParams"), &Z_Registration_Info_UScriptStruct_NetParams, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNetParams), 16284029U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_WeaponSystemPlugin_Public_WeaponSystem_Character_WeaponSystemPlayerController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AWeaponSystemPlayerController, AWeaponSystemPlayerController::StaticClass, TEXT("AWeaponSystemPlayerController"), &Z_Registration_Info_UClass_AWeaponSystemPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AWeaponSystemPlayerController), 2065231561U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_WeaponSystemPlugin_Public_WeaponSystem_Character_WeaponSystemPlayerController_h_4194506925(TEXT("/Script/WeaponSystemPlugin"),
		Z_CompiledInDeferFile_FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_WeaponSystemPlugin_Public_WeaponSystem_Character_WeaponSystemPlayerController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_WeaponSystemPlugin_Public_WeaponSystem_Character_WeaponSystemPlayerController_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_WeaponSystemPlugin_Public_WeaponSystem_Character_WeaponSystemPlayerController_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_WeaponSystemPlugin_Public_WeaponSystem_Character_WeaponSystemPlayerController_h_Statics::ScriptStructInfo),
		nullptr, 0);
