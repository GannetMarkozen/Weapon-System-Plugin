...
#define FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_WeaponSystemPlugin_Public_WeaponSystem_AttributeSystem_AggregateTagContainer_h_93_DELEGATE \
...
static inline void FAggregateContainerChangedDelegate_DelegateWrapper(const FMulticastScriptDelegate& AggregateContainerChangedDelegate, FAggregateTagContainer const& TagContainer, FGameplayTag const& Tag, int32 CurrentCount, int32 OldCount) \
{ \
	_Script_WeaponSystemPlugin_eventAggregateContainerChangedDelegate_Parms Parms; \
	Parms.TagContainer=TagContainer; \
	Parms.Tag=Tag; \
	Parms.CurrentCount=CurrentCount; \
	Parms.OldCount=OldCount; \
	AggregateContainerChangedDelegate.ProcessMulticastDelegate<UObject>(&Parms); \
}


#define FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_WeaponSystemPlugin_Public_WeaponSystem_AttributeSystem_AggregateTagContainer_h_94_DELEGATE \
...
static inline void FAggregateContainerChangedUniDelegate_DelegateWrapper(const FScriptDelegate& AggregateContainerChangedUniDelegate, FAggregateTagContainer const& TagContainer, FGameplayTag const& Tag, int32 CurrentCount, int32 OldCount) \
{ \
