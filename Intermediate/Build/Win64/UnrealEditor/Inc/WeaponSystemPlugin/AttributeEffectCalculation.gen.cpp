...
// End Cross Module References
	DEFINE_FUNCTION(UAttributeEffectCalculation::execModify)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->Modify_Implementation(Z_Param_CurrentValue,Z_Param_Out_Attribute,Z_Param_Effect,Z_Param_AttributesComponent,Z_Param_Out_Context,(EEffectModType&)(Z_Param_Out_OutModificationType),Z_Param_Out_OutValue);
		P_NATIVE_END;
	}
	...
	static FName NAME_UAttributeEffectCalculation_Modify = FName(TEXT("Modify"));
	void UAttributeEffectCalculation::Modify(const float CurrentValue, FAttributeHandle const& Attribute, const UAttributeEffect* Effect, const UAttributesComponent* AttributesComponent, FPolyStructHandle& Context, EEffectModType& OutModificationType, float& OutValue) const
	{
		AttributeEffectCalculation_eventModify_Parms Parms;
		...
		const_cast<UAttributeEffectCalculation*>(this)->ProcessEvent(FindFunctionChecked(NAME_UAttributeEffectCalculation_Modify),&Parms);
	...
	void UAttributeEffectCalculation::StaticRegisterNativesUAttributeEffectCalculation()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "Modify", &UAttributeEffectCalculation::execModify },
		};
	...
	struct Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_CurrentValue_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_CurrentValue = { "CurrentValue", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AttributeEffectCalculation_eventModify_Parms, CurrentValue), METADATA_PARAMS(Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_CurrentValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_CurrentValue_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_Attribute_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_Attribute = { "Attribute", nullptr, (EPropertyFlags)0x0010008008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AttributeEffectCalculation_eventModify_Parms, Attribute), Z_Construct_UScriptStruct_FAttributeHandle, METADATA_PARAMS(Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_Attribute_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_Attribute_MetaData)) }; // 4070662230
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_Effect_MetaData[] = {
		{ "EditInline", "true" },
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_Effect = { "Effect", nullptr, (EPropertyFlags)0x0010000000080082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AttributeEffectCalculation_eventModify_Parms, Effect), Z_Construct_UClass_UAttributeEffect_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_Effect_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_Effect_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_AttributesComponent_MetaData[] = {
		{ "EditInline", "true" },
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_AttributesComponent = { "AttributesComponent", nullptr, (EPropertyFlags)0x0010000000080082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AttributeEffectCalculation_eventModify_Parms, AttributesComponent), Z_Construct_UClass_UAttributesComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_AttributesComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_AttributesComponent_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_Context = { "Context", nullptr, (EPropertyFlags)0x0010000008000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AttributeEffectCalculation_eventModify_Parms, Context), Z_Construct_UScriptStruct_FPolyStructHandle, METADATA_PARAMS(nullptr, 0) }; // 2519392893
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_OutModificationType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_OutModificationType = { "OutModificationType", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AttributeEffectCalculation_eventModify_Parms, OutModificationType), Z_Construct_UEnum_WeaponSystemPlugin_EEffectModType, METADATA_PARAMS(nullptr, 0) }; // 347396436
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_OutValue = { "OutValue", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AttributeEffectCalculation_eventModify_Parms, OutValue), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_CurrentValue,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_Attribute,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_Effect,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_AttributesComponent,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_Context,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_OutModificationType_Underlying,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_OutModificationType,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::NewProp_OutValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::Function_MetaDataParams[] = {
		{ "Category", "Effect Calculation" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAttributeEffectCalculation, nullptr, "Modify", nullptr, nullptr, sizeof(AttributeEffectCalculation_eventModify_Parms), Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x48480C00, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UAttributeEffectCalculation_Modify()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UAttributeEffectCalculation_Modify_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAttributeEffectCalculation_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAttributeEffectCalculation_CanModifyAttribute, "CanModifyAttribute" }, // 2790344910
		{ &Z_Construct_UFunction_UAttributeEffectCalculation_Modify, "Modify" }, // 1375841385
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_WeaponSystemPlugin_Public_WeaponSystem_AttributeSystem_AttributeEffectCalculation_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAttributeEffectCalculation, UAttributeEffectCalculation::StaticClass, TEXT("UAttributeEffectCalculation"), &Z_Registration_Info_UClass_UAttributeEffectCalculation, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAttributeEffectCalculation), 2385956111U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_AnimeShooter_Plugins_WeaponSystemPlugin_Source_WeaponSystemPlugin_Public_WeaponSystem_AttributeSystem_AttributeEffectCalculation_h_1948278537(TEXT("/Script/WeaponSystemPlugin"),
