...
// End Cross Module References
	DEFINE_FUNCTION(UAttributeEffectCalculation::execModifyAttribute)
	{
		...
		P_GET_PROPERTY(FFloatProperty,Z_Param_CurrentModificationValue);
		...
		P_GET_PROPERTY_REF(FFloatProperty,Z_Param_Out_OutModificationValue);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->ModifyAttribute_Implementation(Z_Param_AttributeValue,Z_Param_CurrentModificationValue,Z_Param_Magnitude,Z_Param_Out_Attribute,Z_Param_Effect,Z_Param_AttributesComponent,Z_Param_Out_ModificationContext,(EEffectModType&)(Z_Param_Out_OutModificationType),Z_Param_Out_OutModificationValue);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UAttributeEffectCalculation::execCanModifyAttribute)
	{
		...
		P_GET_OBJECT(UAttributeEffect,Z_Param_Effect);
		P_GET_OBJECT(UAttributesComponent,Z_Param_AttributesComponent);
		P_GET_STRUCT_REF(FEffectModContext,Z_Param_Out_ModContext);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=P_THIS->CanModifyAttribute_Implementation(Z_Param_Out_Attribute,Z_Param_Effect,Z_Param_AttributesComponent,Z_Param_Out_ModContext);
		P_NATIVE_END;
	}
	static FName NAME_UAttributeEffectCalculation_CanModifyAttribute = FName(TEXT("CanModifyAttribute"));
	bool UAttributeEffectCalculation::CanModifyAttribute(FAttributeHandle const& Attribute, const UAttributeEffect* Effect, const UAttributesComponent* AttributesComponent, FEffectModContext const& ModContext) const
	{
	...
	void UAttributeEffectCalculation::ModifyAttribute(const float AttributeValue, const float CurrentModificationValue, const float Magnitude, FAttributeHandle const& Attribute, const UAttributeEffect* Effect, const UAttributesComponent* AttributesComponent, FEffectModContext const& ModificationContext, EEffectModType& OutModificationType, float& OutModificationValue) const
	{
		...
		Parms.OutModificationValue=OutModificationValue;
		...
		OutModificationValue=Parms.OutModificationValue;
	}
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAttributeEffectCalculation_CanModifyAttribute_Statics::NewProp_ModContext_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAttributeEffectCalculation_CanModifyAttribute_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAttributeEffectCalculation_CanModifyAttribute_Statics::NewProp_ModContext,
	...
	struct Z_Construct_UFunction_UAttributeEffectCalculation_ModifyAttribute_Statics
	{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_CurrentModificationValue_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_CurrentModificationValue;
#if WITH_METADATA
		...
		static const UECodeGen_Private::FFloatPropertyParams NewProp_OutModificationValue;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAttributeEffectCalculation_ModifyAttribute_Statics::NewProp_CurrentModificationValue_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAttributeEffectCalculation_ModifyAttribute_Statics::NewProp_CurrentModificationValue = { "CurrentModificationValue", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AttributeEffectCalculation_eventModifyAttribute_Parms, CurrentModificationValue), METADATA_PARAMS(Z_Construct_UFunction_UAttributeEffectCalculation_ModifyAttribute_Statics::NewProp_CurrentModificationValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAttributeEffectCalculation_ModifyAttribute_Statics::NewProp_CurrentModificationValue_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAttributeEffectCalculation_ModifyAttribute_Statics::NewProp_Magnitude_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAttributeEffectCalculation_ModifyAttribute_Statics::NewProp_Magnitude = { "Magnitude", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AttributeEffectCalculation_eventModifyAttribute_Parms, Magnitude), METADATA_PARAMS(Z_Construct_UFunction_UAttributeEffectCalculation_ModifyAttribute_Statics::NewProp_Magnitude_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAttributeEffectCalculation_ModifyAttribute_Statics::NewProp_Magnitude_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAttributeEffectCalculation_ModifyAttribute_Statics::NewProp_ModificationContext_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAttributeEffectCalculation_ModifyAttribute_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAttributeEffectCalculation_ModifyAttribute_Statics::NewProp_CurrentModificationValue,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAttributeEffectCalculation_ModifyAttribute_Statics::NewProp_Magnitude,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAttributeEffectCalculation_ModifyAttribute_Statics::NewProp_ModificationContext,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAttributeEffectCalculation_ModifyAttribute_Statics::NewProp_OutModificationValue,
	};
#if WITH_METADATA
